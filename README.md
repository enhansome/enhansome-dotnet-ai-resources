...
Inspired by [frontend-dev-bookmarks](https://github.com/dypsilon/frontend-dev-bookmarks) ⭐ 47,374 | 🐛 132 | 📅 2024-05-21, [ruby-bookmarks](https://github.com/dreikanter/ruby-bookmarks) ⭐ 2,301 | 🐛 0 | 📅 2026-04-09, [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning) ⭐ 74,011 | 🐛 24 | 🌐 Python | 📅 2026-08-11, [awesome-generative-ai](https://github.com/steven2358/awesome-generative-ai) ⭐ 12,491 | 🐛 561 | 📅 2026-08-03 and [awesome-dotnet](https://github.com/quozd/awesome-dotnet) ⭐ 21,553 | 🐛 137 | 📅 2026-03-26.
...
* [eShop Reference Application](https://github.com/dotnet/eShop/) ⭐ 10,771 | 🐛 183 | 🌐 C# | 📅 2026-08-07 - An eCommerce sample application built on .NET 8, .NET Aspire, and using Semantic Kernel to demonstrate an AI chat bot.
...
* [AugmentR](https://github.com/bradygaster/AugmentR) ⭐ 55 | 🐛 3 | 🌐 C# | 📅 2024-03-29 - An example chat bot demonstrating the use of Semantic Kernel in a .NET Aspire project, augmenting chats with data from public internet URLs.
...
* [Microsoft.Extensions.AI Source on GitHub](https://github.com/dotnet/extensions/tree/main/src/Libraries/Microsoft.Extensions.AI) ⭐ 3,194 | 🐛 245 | 🌐 C# | 📅 2026-08-12
* [Samples for Microsoft.Extensions.AI](https://github.com/dotnet/extensions/tree/main/src/Libraries/Microsoft.Extensions.AI) ⭐ 3,194 | 🐛 245 | 🌐 C# | 📅 2026-08-12
...
* [OpenAI SDK for .NET on GitHub](https://github.com/openai/openai-dotnet) ⭐ 2,665 | 🐛 60 | 🌐 C# | 📅 2026-08-12 - Includes the source, documentation, and samples for working with the library.
...
* [Semantic Kernel Source on GitHub](https://github.com/microsoft/semantic-kernel) ⭐ 28,445 | 🐛 242 | 🌐 C# | 📅 2026-08-11
* [Semantic Kernel Cookbook](https://github.com/microsoft/SemanticKernelCookBook) ⭐ 316 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2024-08-06 - A set of examples for achieving common tasks using Semantic Kernel, with Polyglot Notebooks available for .NET developers.
...
* [NRedis Stack .NET SDK](https://github.com/redis/NRedisStack) ⭐ 326 | 🐛 7 | 🌐 C# | 📅 2026-08-12 - A .NET SDK for working with Redis Enterprise for Vector Similarity Search
...
* [Azure OpenAI Service Samples](https://github.com/Azure-Samples/openai/) ⭐ 1,339 | 🐛 65 | 🌐 Jupyter Notebook | 📅 2025-11-20 - Sample notebooks demonstrating how to use the Azure OpenAI SDK, with may samples in C#/.NET as Polyglot Notebooks.
* [Azure Functions bindings for OpenAI's GPT engine](https://github.com/Azure/azure-functions-openai-extension) ⭐ 101 | 🐛 14 | 🌐 C# | 📅 2026-08-05 - **\[In Development]** Very early review of new OpenAI bindings in Azure Functions, including support for C#.
