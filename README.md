...
Inspired by [frontend-dev-bookmarks](https://github.com/dypsilon/frontend-dev-bookmarks) ⭐ 47,500 | 🐛 134 | 📅 2024-05-21, [ruby-bookmarks](https://github.com/dreikanter/ruby-bookmarks) ⭐ 2,304 | 🐛 0 | 📅 2026-04-09, [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning) ⭐ 74,308 | 🐛 34 | 🌐 Python | 📅 2026-09-08, [awesome-generative-ai](https://github.com/steven2358/awesome-generative-ai) ⭐ 12,630 | 🐛 657 | 📅 2026-09-09 and [awesome-dotnet](https://github.com/quozd/awesome-dotnet) ⭐ 21,595 | 🐛 152 | 📅 2026-03-26.
...
* [Generative AI with .NET for Beginners](https://youtube.com/playlist?list=PLdo4fOcmZ0oW_k4_eDTPWDLUVWz7A9y0M\&si=c7B1fz4oQQYHEfy2) - An introductory course from Microsoft, summarizing the differences betwen Generative AI, Machine Learning (ML) and how you can get started with both.
  * [Source code for AI Beginner Series](https://github.com/dotnet/beginner-series/tree/main/Artificial%20Intelligence%20and%20Machine%20Learning) ⭐ 389 | 🐛 8 | 🌐 Jupyter Notebook | 📅 2026-09-11 - The presentation and sample source from the above intro series.
...
* [eShop Reference Application](https://github.com/dotnet/eShop/) ⭐ 10,858 | 🐛 124 | 🌐 C# | 📅 2026-08-31 - An eCommerce sample application built on .NET 8, .NET Aspire, and using Semantic Kernel to demonstrate an AI chat bot.
...
* [AI Chat App Quickstart using ASP.NET Core and a Blazor frontend](https://github.com/Azure-Samples/ai-chat-quickstart-csharp/) ⭐ 12 | 🐛 8 | 🌐 Bicep | 📅 2024-10-21 - Includes support for working with OpenAI models, local models, models available through GitHub Models, and Azure AI Model Catalog.
...
* [Microsoft.Extensions.AI Source on GitHub](https://github.com/dotnet/extensions/tree/main/src/Libraries/Microsoft.Extensions.AI) ⭐ 3,209 | 🐛 261 | 🌐 C# | 📅 2026-09-11
* [Samples for Microsoft.Extensions.AI](https://github.com/dotnet/extensions/tree/main/src/Libraries/Microsoft.Extensions.AI) ⭐ 3,209 | 🐛 261 | 🌐 C# | 📅 2026-09-11
...
* [OpenAI SDK for .NET on GitHub](https://github.com/openai/openai-dotnet) ⭐ 2,689 | 🐛 65 | 🌐 C# | 📅 2026-09-12 - Includes the source, documentation, and samples for working with the library.
...
* [Semantic Kernel Source on GitHub](https://github.com/microsoft/semantic-kernel) ⭐ 28,552 | 🐛 289 | 🌐 C# | 📅 2026-09-11
...
* [LangChain](https://github.com/tryAGI/LangChain/) ⭐ 1,073 | 🐛 48 | 🌐 C# | 📅 2026-09-11 **\[Unofficial]** - .NET implementation of the popular LangChain Python project. Note: Currently it's in an early state, and looking for contributors!

## Vector Store SDKs

* [NRedis Stack .NET SDK](https://github.com/redis/NRedisStack) ⭐ 331 | 🐛 3 | 🌐 C# | 📅 2026-09-11 - A .NET SDK for working with Redis Enterprise for Vector Similarity Search
...
* [Azure OpenAI Service Samples](https://github.com/Azure-Samples/openai/) ⭐ 1,346 | 🐛 65 | 🌐 Jupyter Notebook | 📅 2026-08-20 - Sample notebooks demonstrating how to use the Azure OpenAI SDK, with may samples in C#/.NET as Polyglot Notebooks.
* [Azure Functions bindings for OpenAI's GPT engine](https://github.com/Azure/azure-functions-openai-extension) ⭐ 101 | 🐛 13 | 🌐 C# | 📅 2026-09-11 - **\[In Development]** Very early review of new OpenAI bindings in Azure Functions, including support for C#.
