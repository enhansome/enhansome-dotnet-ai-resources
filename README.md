...
Inspired by [frontend-dev-bookmarks](https://github.com/dypsilon/frontend-dev-bookmarks) ⭐ 47,400 | 🐛 133 | 📅 2024-05-21, [ruby-bookmarks](https://github.com/dreikanter/ruby-bookmarks) ⭐ 2,302 | 🐛 0 | 📅 2026-04-09, [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning) ⭐ 74,080 | 🐛 26 | 🌐 Python | 📅 2026-08-11, [awesome-generative-ai](https://github.com/steven2358/awesome-generative-ai) ⭐ 12,515 | 🐛 583 | 📅 2026-08-03 and [awesome-dotnet](https://github.com/quozd/awesome-dotnet) ⭐ 21,560 | 🐛 139 | 📅 2026-03-26.
...
* [eShop Reference Application](https://github.com/dotnet/eShop/) ⭐ 10,782 | 🐛 185 | 🌐 C# | 📅 2026-08-18 - An eCommerce sample application built on .NET 8, .NET Aspire, and using Semantic Kernel to demonstrate an AI chat bot.
* [Azure Search with OpenAI - C# Sample](https://github.com/Azure-Samples/azure-search-openai-demo-csharp/) ⭐ 840 | 🐛 72 | 🌐 C# | 📅 2025-07-29 - [Documentation](https://learn.microsoft.com/dotnet/azure/ai/get-started-app-chat-template?tabs=github-codespaces) | [Announcement Post](https://devblogs.microsoft.com/dotnet/transform-business-smart-dotnet-apps-azure-chatgpt/) ChatGPT + Enterprise data with Azure OpenAI and Cognitive Search (.NET)
...
* [Microsoft.Extensions.AI Source on GitHub](https://github.com/dotnet/extensions/tree/main/src/Libraries/Microsoft.Extensions.AI) ⭐ 3,200 | 🐛 247 | 🌐 C# | 📅 2026-08-20
* [Samples for Microsoft.Extensions.AI](https://github.com/dotnet/extensions/tree/main/src/Libraries/Microsoft.Extensions.AI) ⭐ 3,200 | 🐛 247 | 🌐 C# | 📅 2026-08-20
...
* [OpenAI SDK for .NET on GitHub](https://github.com/openai/openai-dotnet) ⭐ 2,669 | 🐛 70 | 🌐 C# | 📅 2026-08-20 - Includes the source, documentation, and samples for working with the library.
...
* [Semantic Kernel Source on GitHub](https://github.com/microsoft/semantic-kernel) ⭐ 28,467 | 🐛 250 | 🌐 C# | 📅 2026-08-20
...
* [LangChain](https://github.com/tryAGI/LangChain/) ⭐ 1,069 | 🐛 51 | 🌐 C# | 📅 2026-07-17 **\[Unofficial]** - .NET implementation of the popular LangChain Python project. Note: Currently it's in an early state, and looking for contributors!
...
* [Azure OpenAI Service Samples](https://github.com/Azure-Samples/openai/) ⭐ 1,341 | 🐛 66 | 🌐 Jupyter Notebook | 📅 2026-08-20 - Sample notebooks demonstrating how to use the Azure OpenAI SDK, with may samples in C#/.NET as Polyglot Notebooks.
