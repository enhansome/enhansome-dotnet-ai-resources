...
Inspired by [frontend-dev-bookmarks](https://github.com/dypsilon/frontend-dev-bookmarks) ⭐ 47,495 | 🐛 134 | 📅 2024-05-21, [ruby-bookmarks](https://github.com/dreikanter/ruby-bookmarks) ⭐ 2,303 | 🐛 0 | 📅 2026-04-09, [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning) ⭐ 74,291 | 🐛 34 | 🌐 Python | 📅 2026-09-08, [awesome-generative-ai](https://github.com/steven2358/awesome-generative-ai) ⭐ 12,599 | 🐛 649 | 📅 2026-09-09 and [awesome-dotnet](https://github.com/quozd/awesome-dotnet) ⭐ 21,592 | 🐛 150 | 📅 2026-03-26.
...
* [eShop Reference Application](https://github.com/dotnet/eShop/) ⭐ 10,852 | 🐛 124 | 🌐 C# | 📅 2026-08-31 - An eCommerce sample application built on .NET 8, .NET Aspire, and using Semantic Kernel to demonstrate an AI chat bot.
...
* [Microsoft.Extensions.AI Source on GitHub](https://github.com/dotnet/extensions/tree/main/src/Libraries/Microsoft.Extensions.AI) ⭐ 3,208 | 🐛 260 | 🌐 C# | 📅 2026-09-10
* [Samples for Microsoft.Extensions.AI](https://github.com/dotnet/extensions/tree/main/src/Libraries/Microsoft.Extensions.AI) ⭐ 3,208 | 🐛 260 | 🌐 C# | 📅 2026-09-10
...
* [OpenAI SDK for .NET on GitHub](https://github.com/openai/openai-dotnet) ⭐ 2,687 | 🐛 66 | 🌐 C# | 📅 2026-09-10 - Includes the source, documentation, and samples for working with the library.
...
* [Semantic Kernel Source on GitHub](https://github.com/microsoft/semantic-kernel) ⭐ 28,552 | 🐛 269 | 🌐 C# | 📅 2026-09-09
...
* [NRedis Stack .NET SDK](https://github.com/redis/NRedisStack) ⭐ 330 | 🐛 3 | 🌐 C# | 📅 2026-09-10 - A .NET SDK for working with Redis Enterprise for Vector Similarity Search
